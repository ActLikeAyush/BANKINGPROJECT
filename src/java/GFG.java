...
//        System.out.println(numberToWords(n));
        ...
        n=1234;
        System.out.println("dyiafvafhajh           :"+numberToWords(n));
    }
}
...
//         String accountna="A006";
//          String Account="";
//             int accountnum=1;
//             String aa;
//             //ccountname+accountnum;
//             System.out.println();
//             int l =accountna.length();
//             int a=4;
//             if(a<l)
//             {
//                 a=l;
//            aa=accountna.substring(1,a);
//            System.out.println(a+"AB"+aa);
//             }
//             else
//             {
//             aa=accountna.substring(1,a);
...
//             int ab=1234;
//             int ac= -1234;
//             String str1=Integer.toString(ab);
//             String str2=Integer.toString(ac);
